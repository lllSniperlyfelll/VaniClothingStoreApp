            ...
            <React.Fragment>
                <div className="sticky-top">
                    <nav className="navbar navbar-light bg-accent text-white">
                        <button className="navbar-toggler btn outline-0 text-white border-0" type="button" data-toggle="collapse" data-target="#parentNavbar" aria-controls="parentNavbar" aria-expanded="false" aria-label="Toggle navigation">
                            <i className="fa fa-bars"></i>
                        </button>
                        <span className="text-white title-font h2">
                            {appTitle}
                        </span>
                    </nav>
